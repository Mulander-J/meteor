import undersocre from 'underscore'
const _ = undersocre._
...
export const _pixel = (eleId)=>{
    ...
    class FullscreenCanvas {
        ...
        adjust() {
            ...
            this.realWidth = canvas.width = clientWidth * scale;
            this.realHeight = canvas.height = clientHeight * scale;
    ...
    const shape = {
        ...
        galaxy() {
            this.spiral({
                ...
                lifeTime: 100,
                electronCount: 1 });
            timer = setTimeout(this.galaxy, 16);
        },

        ring() {
            this.spiral();
            timer = setTimeout(this.ring, 16);
        },
